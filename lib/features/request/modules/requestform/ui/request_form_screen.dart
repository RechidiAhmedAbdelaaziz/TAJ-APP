...
class RequestFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isLoading = context.select(
      (RequestFormCubit cubit) => cubit.isLoading && !cubit.isLoaded,
    );
    return BlocListener<RequestFormCubit, RequestFormState>(
      listener: (context, state) {
        state.onSuccess((request) {
          context.back(request);
            ...
            child: AppButton(
              ...
              isLoading:
                  (context) => context.select(
                    (RequestFormCubit cubit) => cubit.isLoading,
                  ),
